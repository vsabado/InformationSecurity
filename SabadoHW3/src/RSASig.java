...
public class RSASig {
    private static void makeStoreKeys() throws IOException, NoSuchAlgorithmException {
        ...
        new FileOutputStream("outputRSASig/AlicePrivateKey/privkey.key").write(pair.getPrivate().getEncoded());
    ...
    private static PrivateKey restorePrivate() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        byte[] bytes = Files.readAllBytes(Paths.get("outputRSASig/AlicePrivateKey/privkey.key"));
